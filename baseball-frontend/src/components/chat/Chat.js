    ...
    return (
        ...
        <div className="chat-container" ref={chatContainerRef} style={{ fontSize }}>
            ...
            <div className="chat-input-section">
                ...
                >
                    {" "}
            <circle cx="8" cy="8" r="7" fill="yellow" />
            <circle
              cx="8"
              cy="8"
              r="7"
            ...
            <path
              fill="black"
              fillRule="evenodd"
              d="M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5zm4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5zM4.285 9.567a.5.5 0 0 1 .683.183A3.5 3.5 0 0 0 8 11.5a3.5 3.5 0 0 0 3.032-1.75.5.5 0 1 1 .866.5A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1-3.898-2.25.5.5 0 0 1 .183-.683z"
            />
                </svg>
        ...
        {emojiPick && (
          <div className="emoji-picker-container">
            ...
            <Emoji onSelect={emojiMessage} />
          </div>
        )}
        <div className="chat-font-size-row">                
